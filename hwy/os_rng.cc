...
// Windows, thus HWY_OS_RNG_SECURE_SEED=0 when this is 0 and we are not on
// Windows.
#if defined(ANDROID) || defined(__ANDROID__) || \
    (HWY_ARCH_RISCV && !HWY_OS_LINUX)
#define HWY_OS_RNG_GETRANDOM 0
#endif

#if !defined(HWY_OS_RNG_GETRANDOM) && HWY_OS_LINUX
#include <features.h>

// ---- which libc
#if defined(__UCLIBC__)
#define HWY_OS_RNG_GETRANDOM 1  // added Mar 2015, before uclibc-ng 1.0

#elif defined(__GLIBC__) && defined(__GLIBC_PREREQ)
#if __GLIBC_PREREQ(2, 25)
#define HWY_OS_RNG_GETRANDOM 1
#else
#define HWY_OS_RNG_GETRANDOM 0
#endif
...
#if !defined(HWY_OS_RNG_GETRANDOM)
#define HWY_OS_RNG_GETRANDOM 0
#endif

// Retain backwards compatibility with VQSORT_SECURE_SEED.
#if defined(VQSORT_SECURE_SEED)
#define HWY_OS_RNG_SECURE_SEED VQSORT_SECURE_SEED
#endif
...
#ifndef HWY_OS_RNG_SECURE_SEED

#if HWY_OS_RNG_GETRANDOM
#define HWY_OS_RNG_SECURE_SEED 1
#elif defined(_WIN32) || defined(_WIN64)
#define HWY_OS_RNG_SECURE_SEED 2
#else
#define HWY_OS_RNG_SECURE_SEED 0
#endif

#endif  // HWY_OS_RNG_SECURE_SEED

// Pull in dependencies of the chosen seed source.
#if HWY_OS_RNG_SECURE_SEED == 1
#include <sys/random.h>
#elif HWY_OS_RNG_SECURE_SEED == 2
#ifndef NOMINMAX
#define NOMINMAX
#endif  // NOMINMAX
