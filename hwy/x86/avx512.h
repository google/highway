...
#ifndef HWY_X86_AVX512_H_
#define HWY_X86_AVX512_H_
...
class Vec512 {
 ...
 public:
  ...
  HWY_ATTR_AVX512 HWY_INLINE Vec512& operator*=(const Vec512 other) {
...
HWY_ATTR_AVX512 HWY_INLINE __m512i BitCastToInteger(__m512i v) { return v; }
HWY_ATTR_AVX512 HWY_INLINE __m512i BitCastToInteger(__m512 v) {
  return _mm512_castps_si512(v);
}
HWY_ATTR_AVX512 HWY_INLINE __m512i BitCastToInteger(__m512d v) {
  return _mm512_castpd_si512(v);
}

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> cast_to_u8(Vec512<T> v) {
...
struct BitCastFromInteger512 {
  HWY_ATTR_AVX512 HWY_INLINE __m512i operator()(__m512i v) { return v; }
};
template <>
struct BitCastFromInteger512<float> {
  HWY_ATTR_AVX512 HWY_INLINE __m512 operator()(__m512i v) {
    return _mm512_castsi512_ps(v);
  }
};
template <>
struct BitCastFromInteger512<double> {
  HWY_ATTR_AVX512 HWY_INLINE __m512d operator()(__m512i v) {
    return _mm512_castsi512_pd(v);
  }
};

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> cast_u8_to(Full512<T> /* tag */,
                                                Vec512<uint8_t> v) {
  return Vec512<T>{BitCastFromInteger512<T>()(v.raw)};
}

template <typename T, typename FromT>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> BitCast(Full512<T> d, Vec512<FromT> v) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> Zero(Full512<T> /* tag */) {
  return Vec512<T>{_mm512_setzero_si512()};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Zero(Full512<float> /* tag */) {
  return Vec512<float>{_mm512_setzero_ps()};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Zero(Full512<double> /* tag */) {
  return Vec512<double>{_mm512_setzero_pd()};
}

// Returns a vector with all lanes set to "t".
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> Set(Full512<uint8_t> /* tag */,
                                               const uint8_t t) {
  return Vec512<uint8_t>{_mm512_set1_epi8(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> Set(Full512<uint16_t> /* tag */,
                                                const uint16_t t) {
  return Vec512<uint16_t>{_mm512_set1_epi16(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> Set(Full512<uint32_t> /* tag */,
                                                const uint32_t t) {
  return Vec512<uint32_t>{_mm512_set1_epi32(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> Set(Full512<uint64_t> /* tag */,
                                                const uint64_t t) {
  return Vec512<uint64_t>{_mm512_set1_epi64(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> Set(Full512<int8_t> /* tag */,
                                              const int8_t t) {
  return Vec512<int8_t>{_mm512_set1_epi8(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> Set(Full512<int16_t> /* tag */,
                                               const int16_t t) {
  return Vec512<int16_t>{_mm512_set1_epi16(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> Set(Full512<int32_t> /* tag */,
                                               const int32_t t) {
  return Vec512<int32_t>{_mm512_set1_epi32(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> Set(Full512<int64_t> /* tag */,
                                               const int64_t t) {
  return Vec512<int64_t>{_mm512_set1_epi64(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Set(Full512<float> /* tag */,
                                             const float t) {
  return Vec512<float>{_mm512_set1_ps(t)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Set(Full512<double> /* tag */,
                                              const double t) {
  return Vec512<double>{_mm512_set1_pd(t)};
}

template <typename T, typename T2>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> Iota(Full512<T> d, const T2 first) {
  alignas(64) T lanes[d.N];
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> Undefined(Full512<T> /* tag */) {
#ifdef __clang__
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Undefined(Full512<float> /* tag */) {
#ifdef __clang__
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Undefined(Full512<double> /* tag */) {
#ifdef __clang__
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> operator&(const Vec512<T> a,
                                               const Vec512<T> b) {
  return Vec512<T>{_mm512_and_si512(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> operator&(const Vec512<float> a,
                                                   const Vec512<float> b) {
  return Vec512<float>{_mm512_and_ps(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> operator&(const Vec512<double> a,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> AndNot(const Vec512<T> not_mask,
                                            const Vec512<T> mask) {
  return Vec512<T>{_mm512_andnot_si512(not_mask.raw, mask.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> AndNot(const Vec512<float> not_mask,
                                                const Vec512<float> mask) {
  return Vec512<float>{_mm512_andnot_ps(not_mask.raw, mask.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> AndNot(const Vec512<double> not_mask,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseImpl(SizeTag<1> /* tag */,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseImpl(SizeTag<2> /* tag */,
                                                    const Mask512<T> mask,
                                                    const Vec512<T> yes,
                                                    const Vec512<T> no) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseImpl(SizeTag<4> /* tag */,
                                                    const Mask512<T> mask,
                                                    const Vec512<T> yes,
                                                    const Vec512<T> no) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseImpl(SizeTag<8> /* tag */,
                                                    const Mask512<T> mask,
                                                    const Vec512<T> yes,
                                                    const Vec512<T> no) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElse(const Mask512<T> mask,
                                                const Vec512<T> yes,
                                                const Vec512<T> no) {
  return IfThenElseImpl(SizeTag<sizeof(T)>(), mask, yes, no);
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> IfThenElse(const Mask512<float> mask,
                                                    const Vec512<float> yes,
                                                    const Vec512<float> no) {
  return Vec512<float>{_mm512_mask_mov_ps(no.raw, mask.raw, yes.raw)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> IfThenElse(const Mask512<double> mask,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseZeroImpl(SizeTag<1> /* tag */,
                                                        const Mask512<T> mask,
                                                        const Vec512<T> yes) {
  return Vec512<T>{_mm512_maskz_mov_epi8(mask.raw, yes.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseZeroImpl(SizeTag<2> /* tag */,
                                                        const Mask512<T> mask,
                                                        const Vec512<T> yes) {
  return Vec512<T>{_mm512_maskz_mov_epi16(mask.raw, yes.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseZeroImpl(SizeTag<4> /* tag */,
                                                        const Mask512<T> mask,
                                                        const Vec512<T> yes) {
  return Vec512<T>{_mm512_maskz_mov_epi32(mask.raw, yes.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseZeroImpl(SizeTag<8> /* tag */,
                                                        const Mask512<T> mask,
                                                        const Vec512<T> yes) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenElseZero(const Mask512<T> mask,
                                                    const Vec512<T> yes) {
  return IfThenElseZeroImpl(SizeTag<sizeof(T)>(), mask, yes);
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> IfThenElseZero(
    const Mask512<float> mask, const Vec512<float> yes) {
  return Vec512<float>{_mm512_maskz_mov_ps(mask.raw, yes.raw)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> IfThenElseZero(
    const Mask512<double> mask, const Vec512<double> yes) {
  return Vec512<double>{_mm512_maskz_mov_pd(mask.raw, yes.raw)};
}

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenZeroElseImpl(SizeTag<1> /* tag */,
                                                        const Mask512<T> mask,
                                                        const Vec512<T> no) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenZeroElseImpl(SizeTag<2> /* tag */,
                                                        const Mask512<T> mask,
                                                        const Vec512<T> no) {
  return Vec512<T>{_mm512_mask_sub_epi16(no.raw, mask.raw, no.raw, no.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenZeroElseImpl(SizeTag<4> /* tag */,
                                                        const Mask512<T> mask,
                                                        const Vec512<T> no) {
  return Vec512<T>{_mm512_mask_xor_epi32(no.raw, mask.raw, no.raw, no.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenZeroElseImpl(SizeTag<8> /* tag */,
                                                        const Mask512<T> mask,
                                                        const Vec512<T> no) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> IfThenZeroElse(const Mask512<T> mask,
                                                    const Vec512<T> no) {
  return IfThenZeroElseImpl(SizeTag<sizeof(T)>(), mask, no);
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> IfThenZeroElse(
    const Mask512<float> mask, const Vec512<float> no) {
  return Vec512<float>{_mm512_mask_xor_ps(no.raw, mask.raw, no.raw, no.raw)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> IfThenZeroElse(
    const Mask512<double> mask, const Vec512<double> no) {
  return Vec512<double>{_mm512_mask_xor_pd(no.raw, mask.raw, no.raw, no.raw)};
}

template <typename T, HWY_IF_FLOAT(T)>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ZeroIfNegative(const Vec512<T> v) {
...
// Unsigned
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> SaturatedAdd(
    const Vec512<uint8_t> a, const Vec512<uint8_t> b) {
  return Vec512<uint8_t>{_mm512_adds_epu8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> SaturatedAdd(
    const Vec512<uint16_t> a, const Vec512<uint16_t> b) {
  return Vec512<uint16_t>{_mm512_adds_epu16(a.raw, b.raw)};
}

// Signed
HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> SaturatedAdd(const Vec512<int8_t> a,
                                                       const Vec512<int8_t> b) {
  return Vec512<int8_t>{_mm512_adds_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> SaturatedAdd(
...
// Unsigned
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> SaturatedSub(
    const Vec512<uint8_t> a, const Vec512<uint8_t> b) {
  return Vec512<uint8_t>{_mm512_subs_epu8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> SaturatedSub(
    const Vec512<uint16_t> a, const Vec512<uint16_t> b) {
  return Vec512<uint16_t>{_mm512_subs_epu16(a.raw, b.raw)};
}

// Signed
HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> SaturatedSub(const Vec512<int8_t> a,
                                                       const Vec512<int8_t> b) {
  return Vec512<int8_t>{_mm512_subs_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> SaturatedSub(
    const Vec512<int16_t> a, const Vec512<int16_t> b) {
...
// Unsigned
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> AverageRound(
    const Vec512<uint8_t> a, const Vec512<uint8_t> b) {
  return Vec512<uint8_t>{_mm512_avg_epu8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> AverageRound(
    const Vec512<uint16_t> a, const Vec512<uint16_t> b) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> Abs(const Vec512<int8_t> v) {
  return Vec512<int8_t>{_mm512_abs_epi8(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> Abs(const Vec512<int16_t> v) {
  return Vec512<int16_t>{_mm512_abs_epi16(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> Abs(const Vec512<int32_t> v) {
...
template <int kBits>
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> ShiftLeft(const Vec512<int16_t> v) {
  return Vec512<int16_t>{_mm512_slli_epi16(v.raw, kBits)};
}
template <int kBits>
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> ShiftRight(const Vec512<int16_t> v) {
  return Vec512<int16_t>{_mm512_srai_epi16(v.raw, kBits)};
}
template <int kBits>
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> ShiftLeft(const Vec512<int32_t> v) {
  return Vec512<int32_t>{_mm512_slli_epi32(v.raw, kBits)};
}
template <int kBits>
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> ShiftRight(const Vec512<int32_t> v) {
  return Vec512<int32_t>{_mm512_srai_epi32(v.raw, kBits)};
}
template <int kBits>
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> ShiftLeft(const Vec512<int64_t> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> operator<<(
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> operator<<(
...
// Unsigned (no u64)
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> Min(const Vec512<uint8_t> a,
                                               const Vec512<uint8_t> b) {
  return Vec512<uint8_t>{_mm512_min_epu8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> Min(const Vec512<uint16_t> a,
                                                const Vec512<uint16_t> b) {
  return Vec512<uint16_t>{_mm512_min_epu16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> Min(const Vec512<uint32_t> a,
                                                const Vec512<uint32_t> b) {
  return Vec512<uint32_t>{_mm512_min_epu32(a.raw, b.raw)};
}

// Signed (no i64)
HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> Min(const Vec512<int8_t> a,
                                              const Vec512<int8_t> b) {
  return Vec512<int8_t>{_mm512_min_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> Min(const Vec512<int16_t> a,
                                               const Vec512<int16_t> b) {
  return Vec512<int16_t>{_mm512_min_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> Min(const Vec512<int32_t> a,
                                               const Vec512<int32_t> b) {
  return Vec512<int32_t>{_mm512_min_epi32(a.raw, b.raw)};
}

// Float
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Min(const Vec512<float> a,
                                             const Vec512<float> b) {
  return Vec512<float>{_mm512_min_ps(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Min(const Vec512<double> a,
                                              const Vec512<double> b) {
...
// Unsigned (no u64)
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> Max(const Vec512<uint8_t> a,
                                               const Vec512<uint8_t> b) {
  return Vec512<uint8_t>{_mm512_max_epu8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> Max(const Vec512<uint16_t> a,
                                                const Vec512<uint16_t> b) {
  return Vec512<uint16_t>{_mm512_max_epu16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> Max(const Vec512<uint32_t> a,
                                                const Vec512<uint32_t> b) {
  return Vec512<uint32_t>{_mm512_max_epu32(a.raw, b.raw)};
}

// Signed (no i64)
HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> Max(const Vec512<int8_t> a,
                                              const Vec512<int8_t> b) {
  return Vec512<int8_t>{_mm512_max_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> Max(const Vec512<int16_t> a,
                                               const Vec512<int16_t> b) {
  return Vec512<int16_t>{_mm512_max_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> Max(const Vec512<int32_t> a,
                                               const Vec512<int32_t> b) {
  return Vec512<int32_t>{_mm512_max_epi32(a.raw, b.raw)};
}

// Float
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Max(const Vec512<float> a,
                                             const Vec512<float> b) {
  return Vec512<float>{_mm512_max_ps(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Max(const Vec512<double> a,
                                              const Vec512<double> b) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> Clamp(const Vec512<T> v,
                                           const Vec512<T> lo,
                                           const Vec512<T> hi) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> MulHigh(const Vec512<uint16_t> a,
                                                    const Vec512<uint16_t> b) {
  return Vec512<uint16_t>{_mm512_mulhi_epu16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> MulHigh(const Vec512<int16_t> a,
                                                   const Vec512<int16_t> b) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> MulEven(const Vec512<int32_t> a,
                                                   const Vec512<int32_t> b) {
  return Vec512<int64_t>{_mm512_mul_epi32(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> MulEven(const Vec512<uint32_t> a,
                                                    const Vec512<uint32_t> b) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Neg(const Vec512<float> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Neg(const Vec512<double> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> ApproximateReciprocal(
...
// Returns mul * x + add
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> MulAdd(const Vec512<float> mul,
                                                const Vec512<float> x,
                                                const Vec512<float> add) {
  return Vec512<float>{_mm512_fmadd_ps(mul.raw, x.raw, add.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> MulAdd(const Vec512<double> mul,
...
// Returns add - mul * x
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> NegMulAdd(const Vec512<float> mul,
                                                   const Vec512<float> x,
                                                   const Vec512<float> add) {
  return Vec512<float>{_mm512_fnmadd_ps(mul.raw, x.raw, add.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> NegMulAdd(const Vec512<double> mul,
                                                    const Vec512<double> x,
                                                    const Vec512<double> add) {
...
// Returns mul * x - sub
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> MulSub(const Vec512<float> mul,
                                                const Vec512<float> x,
                                                const Vec512<float> sub) {
  return Vec512<float>{_mm512_fmsub_ps(mul.raw, x.raw, sub.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> MulSub(const Vec512<double> mul,
                                                 const Vec512<double> x,
...
// Returns -mul * x - sub
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> NegMulSub(const Vec512<float> mul,
                                                   const Vec512<float> x,
                                                   const Vec512<float> sub) {
  return Vec512<float>{_mm512_fnmsub_ps(mul.raw, x.raw, sub.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> NegMulSub(const Vec512<double> mul,
                                                    const Vec512<double> x,
                                                    const Vec512<double> sub) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Sqrt(const Vec512<float> v) {
  return Vec512<float>{_mm512_sqrt_ps(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Sqrt(const Vec512<double> v) {
  return Vec512<double>{_mm512_sqrt_pd(v.raw)};
}

// Approximate reciprocal square root
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> ApproximateReciprocalSqrt(
    const Vec512<float> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Round(const Vec512<float> v) {
  return Vec512<float>{_mm512_roundscale_ps(
      v.raw, _MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Round(const Vec512<double> v) {
  return Vec512<double>{_mm512_roundscale_pd(
      v.raw, _MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC)};
}

// Toward zero, aka truncate
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Trunc(const Vec512<float> v) {
  return Vec512<float>{
      _mm512_roundscale_ps(v.raw, _MM_FROUND_TO_ZERO | _MM_FROUND_NO_EXC)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Trunc(const Vec512<double> v) {
  return Vec512<double>{
      _mm512_roundscale_pd(v.raw, _MM_FROUND_TO_ZERO | _MM_FROUND_NO_EXC)};
}

// Toward +infinity, aka ceiling
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Ceil(const Vec512<float> v) {
  return Vec512<float>{
      _mm512_roundscale_ps(v.raw, _MM_FROUND_TO_POS_INF | _MM_FROUND_NO_EXC)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Ceil(const Vec512<double> v) {
  return Vec512<double>{
      _mm512_roundscale_pd(v.raw, _MM_FROUND_TO_POS_INF | _MM_FROUND_NO_EXC)};
}

// Toward -infinity, aka floor
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Floor(const Vec512<float> v) {
  return Vec512<float>{
      _mm512_roundscale_ps(v.raw, _MM_FROUND_TO_NEG_INF | _MM_FROUND_NO_EXC)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Floor(const Vec512<double> v) {
  return Vec512<double>{
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> TestBitImpl(SizeTag<1> /*tag*/,
                                                  const Vec512<T> v,
                                                  const Vec512<T> bit) {
  return Mask512<T>{_mm512_test_epi8_mask(v.raw, bit.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> TestBitImpl(SizeTag<2> /*tag*/,
                                                  const Vec512<T> v,
                                                  const Vec512<T> bit) {
  return Mask512<T>{_mm512_test_epi16_mask(v.raw, bit.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> TestBitImpl(SizeTag<4> /*tag*/,
                                                  const Vec512<T> v,
                                                  const Vec512<T> bit) {
  return Mask512<T>{_mm512_test_epi32_mask(v.raw, bit.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> TestBitImpl(SizeTag<8> /*tag*/,
                                                  const Vec512<T> v,
                                                  const Vec512<T> bit) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> TestBit(const Vec512<T> v,
                                              const Vec512<T> bit) {
  static_assert(!IsFloat<T>(), "Only integer vectors supported");
  return TestBitImpl(SizeTag<sizeof(T)>(), v, bit);
}

// ------------------------------ Equality

// Unsigned
HWY_ATTR_AVX512 HWY_INLINE Mask512<uint8_t> operator==(
    const Vec512<uint8_t> a, const Vec512<uint8_t> b) {
  return Mask512<uint8_t>{_mm512_cmpeq_epi8_mask(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<uint16_t> operator==(
    const Vec512<uint16_t> a, const Vec512<uint16_t> b) {
  return Mask512<uint16_t>{_mm512_cmpeq_epi16_mask(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<uint32_t> operator==(
    const Vec512<uint32_t> a, const Vec512<uint32_t> b) {
  return Mask512<uint32_t>{_mm512_cmpeq_epi32_mask(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<uint64_t> operator==(
    const Vec512<uint64_t> a, const Vec512<uint64_t> b) {
  return Mask512<uint64_t>{_mm512_cmpeq_epi64_mask(a.raw, b.raw)};
}

// Signed
HWY_ATTR_AVX512 HWY_INLINE Mask512<int8_t> operator==(const Vec512<int8_t> a,
                                                      const Vec512<int8_t> b) {
  return Mask512<int8_t>{_mm512_cmpeq_epi8_mask(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<int16_t> operator==(
    const Vec512<int16_t> a, const Vec512<int16_t> b) {
  return Mask512<int16_t>{_mm512_cmpeq_epi16_mask(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<int32_t> operator==(
    const Vec512<int32_t> a, const Vec512<int32_t> b) {
  return Mask512<int32_t>{_mm512_cmpeq_epi32_mask(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<int64_t> operator==(
    const Vec512<int64_t> a, const Vec512<int64_t> b) {
  return Mask512<int64_t>{_mm512_cmpeq_epi64_mask(a.raw, b.raw)};
}

// Float
HWY_ATTR_AVX512 HWY_INLINE Mask512<float> operator==(const Vec512<float> a,
                                                     const Vec512<float> b) {
  return Mask512<float>{_mm512_cmp_ps_mask(a.raw, b.raw, _CMP_EQ_OQ)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<double> operator==(const Vec512<double> a,
                                                      const Vec512<double> b) {
...
HWY_ATTR_AVX512 HWY_INLINE Mask512<int16_t> operator<(const Vec512<int16_t> a,
                                                      const Vec512<int16_t> b) {
  return Mask512<int16_t>{_mm512_cmpgt_epi16_mask(b.raw, a.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<int32_t> operator<(const Vec512<int32_t> a,
                                                      const Vec512<int32_t> b) {
  return Mask512<int32_t>{_mm512_cmpgt_epi32_mask(b.raw, a.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<int64_t> operator<(const Vec512<int64_t> a,
                                                      const Vec512<int64_t> b) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> MaskFromVecImpl(SizeTag<1> /*tag*/,
                                                      const Vec512<T> v) {
  return Mask512<T>{_mm512_movepi8_mask(v.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> MaskFromVecImpl(SizeTag<2> /*tag*/,
                                                      const Vec512<T> v) {
  return Mask512<T>{_mm512_movepi16_mask(v.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> MaskFromVecImpl(SizeTag<4> /*tag*/,
                                                      const Vec512<T> v) {
  return Mask512<T>{_mm512_movepi32_mask(v.raw)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> MaskFromVecImpl(SizeTag<8> /*tag*/,
                                                      const Vec512<T> v) {
  return Mask512<T>{_mm512_movepi64_mask(v.raw)};
}

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Mask512<T> MaskFromVec(const Vec512<T> v) {
  return MaskFromVecImpl(SizeTag<sizeof(T)>(), v);
}
// There do not seem to be native floating-point versions of these instructions.
HWY_ATTR_AVX512 HWY_INLINE Mask512<float> MaskFromVec(const Vec512<float> v) {
  return Mask512<float>{MaskFromVec(BitCast(Full512<int32_t>(), v)).raw};
}
HWY_ATTR_AVX512 HWY_INLINE Mask512<double> MaskFromVec(const Vec512<double> v) {
  return Mask512<double>{MaskFromVec(BitCast(Full512<int64_t>(), v)).raw};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> VecFromMask(
    const Mask512<uint8_t> v) {
  return Vec512<uint8_t>{_mm512_movm_epi8(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> VecFromMask(const Mask512<int8_t> v) {
  return Vec512<int8_t>{_mm512_movm_epi8(v.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> VecFromMask(
    const Mask512<uint16_t> v) {
  return Vec512<uint16_t>{_mm512_movm_epi16(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> VecFromMask(
    const Mask512<int16_t> v) {
  return Vec512<int16_t>{_mm512_movm_epi16(v.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> VecFromMask(
    const Mask512<uint32_t> v) {
  return Vec512<uint32_t>{_mm512_movm_epi32(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> VecFromMask(
    const Mask512<int32_t> v) {
  return Vec512<int32_t>{_mm512_movm_epi32(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> VecFromMask(const Mask512<float> v) {
  return Vec512<float>{_mm512_castsi512_ps(_mm512_movm_epi32(v.raw))};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> VecFromMask(
    const Mask512<uint64_t> v) {
  return Vec512<uint64_t>{_mm512_movm_epi64(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> VecFromMask(
    const Mask512<int64_t> v) {
  return Vec512<int64_t>{_mm512_movm_epi64(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> VecFromMask(const Mask512<double> v) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> Load(Full512<T> /* tag */,
                                          const T* HWY_RESTRICT aligned) {
  return Vec512<T>{
      _mm512_load_si512(reinterpret_cast<const __m512i*>(aligned))};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Load(
    Full512<float> /* tag */, const float* HWY_RESTRICT aligned) {
  return Vec512<float>{_mm512_load_ps(aligned)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Load(
    Full512<double> /* tag */, const double* HWY_RESTRICT aligned) {
  return Vec512<double>{_mm512_load_pd(aligned)};
}

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> LoadU(Full512<T> /* tag */,
                                           const T* HWY_RESTRICT p) {
  return Vec512<T>{_mm512_loadu_si512(reinterpret_cast<const __m512i*>(p))};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> LoadU(Full512<float> /* tag */,
                                               const float* HWY_RESTRICT p) {
  return Vec512<float>{_mm512_loadu_ps(p)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> LoadU(Full512<double> /* tag */,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> LoadDup128(Full512<T> /* tag */,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE void Store(const Vec512<T> v, Full512<T> /* tag */,
                                      T* HWY_RESTRICT aligned) {
  _mm512_store_si512(reinterpret_cast<__m512i*>(aligned), v.raw);
}
HWY_ATTR_AVX512 HWY_INLINE void Store(const Vec512<float> v,
                                      Full512<float> /* tag */,
                                      float* HWY_RESTRICT aligned) {
  _mm512_store_ps(aligned, v.raw);
}
HWY_ATTR_AVX512 HWY_INLINE void Store(const Vec512<double> v,
                                      Full512<double> /* tag */,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE void StoreU(const Vec512<T> v, Full512<T> /* tag */,
                                       T* HWY_RESTRICT p) {
  _mm512_storeu_si512(reinterpret_cast<__m512i*>(p), v.raw);
}
HWY_ATTR_AVX512 HWY_INLINE void StoreU(const Vec512<float> v,
                                       Full512<float> /* tag */,
                                       float* HWY_RESTRICT p) {
  _mm512_storeu_ps(p, v.raw);
}
HWY_ATTR_AVX512 HWY_INLINE void StoreU(const Vec512<double> v, Full512<double>,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE void Stream(const Vec512<T> v, Full512<T> /* tag */,
                                       T* HWY_RESTRICT aligned) {
  _mm512_stream_si512(reinterpret_cast<__m512i*>(aligned), v.raw);
}
HWY_ATTR_AVX512 HWY_INLINE void Stream(const Vec512<float> v,
                                       Full512<float> /* tag */,
                                       float* HWY_RESTRICT aligned) {
  _mm512_stream_ps(aligned, v.raw);
}
HWY_ATTR_AVX512 HWY_INLINE void Stream(const Vec512<double> v, Full512<double>,
                                       double* HWY_RESTRICT aligned) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> gather_offset_impl(
    SizeTag<4> /* tag */, Full512<T> /* tag */, const T* HWY_RESTRICT base,
    const Vec512<int32_t> offset) {
  return Vec512<T>{_mm512_i32gather_epi32(offset.raw, base, 1)};
}
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> gather_index_impl(
    SizeTag<4> /* tag */, Full512<T> /* tag */, const T* HWY_RESTRICT base,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> gather_offset_impl(
    SizeTag<8> /* tag */, Full512<T> /* tag */, const T* HWY_RESTRICT base,
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> GatherOffset(Full512<T> d,
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> GatherIndex(Full512<T> d,
                                                 const T* HWY_RESTRICT base,
...
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> GatherOffset<float>(
    Full512<float> /* tag */, const float* HWY_RESTRICT base,
    const Vec512<int32_t> offset) {
  return Vec512<float>{_mm512_i32gather_ps(offset.raw, base, 1)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> GatherIndex<float>(
    Full512<float> /* tag */, const float* HWY_RESTRICT base,
    const Vec512<int32_t> index) {
...
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> GatherOffset<double>(
    Full512<double> /* tag */, const double* HWY_RESTRICT base,
    const Vec512<int64_t> offset) {
  return Vec512<double>{_mm512_i64gather_pd(offset.raw, base, 1)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> GatherIndex<double>(
    Full512<double> /* tag */, const double* HWY_RESTRICT base,
    const Vec512<int64_t> index) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE T GetLane(const Vec512<T> v) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec256<T> LowerHalf(Vec512<T> v) {
  return Vec256<T>{_mm512_castsi512_si256(v.raw)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec256<float> LowerHalf(Vec512<float> v) {
  return Vec256<float>{_mm512_castps512_ps256(v.raw)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec256<double> LowerHalf(Vec512<double> v) {
  return Vec256<double>{_mm512_castpd512_pd256(v.raw)};
}

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec256<T> UpperHalf(Vec512<T> v) {
  return Vec256<T>{_mm512_extracti32x8_epi32(v.raw, 1)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec256<float> UpperHalf(Vec512<float> v) {
  return Vec256<float>{_mm512_extractf32x8_ps(v.raw, 1)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec256<double> UpperHalf(Vec512<double> v) {
  return Vec256<double>{_mm512_extractf64x4_pd(v.raw, 1)};
}

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec256<T> GetHalf(Lower /* tag */, Vec512<T> v) {
  return LowerHalf(v);
}

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec256<T> GetHalf(Upper /* tag */, Vec512<T> v) {
  return UpperHalf(v);
}
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ShiftLeftBytes(const Vec512<T> v) {
  static_assert(0 <= kBytes && kBytes <= 16, "Invalid kBytes");
  return Vec512<T>{_mm512_bslli_epi128(v.raw, kBytes)};
}

template <int kLanes, typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ShiftLeftLanes(const Vec512<T> v) {
  return ShiftLeftBytes<kLanes * sizeof(T)>(v);
}

// 0x01..0F, kBytes = 1 => 0x0001..0E
template <int kBytes, typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ShiftRightBytes(const Vec512<T> v) {
  static_assert(0 <= kBytes && kBytes <= 16, "Invalid kBytes");
  return Vec512<T>{_mm512_bsrli_epi128(v.raw, kBytes)};
}

template <int kLanes, typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ShiftRightLanes(const Vec512<T> v) {
...
template <int kBytes, typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> CombineShiftRightBytes(
...
// Unsigned
template <int kLane>
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> Broadcast(
    const Vec512<uint16_t> v) {
...
template <int kLane>
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> Broadcast(
    const Vec512<uint32_t> v) {
...
template <int kLane>
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> Broadcast(
    const Vec512<uint64_t> v) {
...
// Signed
template <int kLane>
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> Broadcast(const Vec512<int16_t> v) {
  static_assert(0 <= kLane && kLane < 8, "Invalid lane");
  if (kLane < 4) {
    const __m512i lo = _mm512_shufflelo_epi16(v.raw, (0x55 * kLane) & 0xFF);
...
template <int kLane>
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> Broadcast(const Vec512<int32_t> v) {
  static_assert(0 <= kLane && kLane < 4, "Invalid lane");
  constexpr _MM_PERM_ENUM perm = static_cast<_MM_PERM_ENUM>(0x55 * kLane);
  return Vec512<int32_t>{_mm512_shuffle_epi32(v.raw, perm)};
}
template <int kLane>
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> Broadcast(const Vec512<int64_t> v) {
  static_assert(0 <= kLane && kLane < 2, "Invalid lane");
  constexpr _MM_PERM_ENUM perm = kLane ? _MM_PERM_DCDC : _MM_PERM_BABA;
...
// Float
template <int kLane>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> Broadcast(const Vec512<float> v) {
  static_assert(0 <= kLane && kLane < 4, "Invalid lane");
  constexpr _MM_PERM_ENUM perm = static_cast<_MM_PERM_ENUM>(0x55 * kLane);
  return Vec512<float>{_mm512_shuffle_ps(v.raw, v.raw, perm)};
}
template <int kLane>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> Broadcast(const Vec512<double> v) {
  static_assert(0 <= kLane && kLane < 2, "Invalid lane");
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Permute512<T> SetTableIndices(const Full512<T> d,
                                                         const int32_t* idx) {
#if !defined(NDEBUG) || defined(ADDRESS_SANITIZER)
  for (size_t i = 0; i < d.N; ++i) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> InterleaveLo(
    const Vec512<uint8_t> a, const Vec512<uint8_t> b) {
  return Vec512<uint8_t>{_mm512_unpacklo_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> InterleaveLo(
    const Vec512<uint16_t> a, const Vec512<uint16_t> b) {
  return Vec512<uint16_t>{_mm512_unpacklo_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> InterleaveLo(
    const Vec512<uint32_t> a, const Vec512<uint32_t> b) {
  return Vec512<uint32_t>{_mm512_unpacklo_epi32(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> InterleaveLo(
    const Vec512<uint64_t> a, const Vec512<uint64_t> b) {
  return Vec512<uint64_t>{_mm512_unpacklo_epi64(a.raw, b.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> InterleaveLo(const Vec512<int8_t> a,
                                                       const Vec512<int8_t> b) {
  return Vec512<int8_t>{_mm512_unpacklo_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> InterleaveLo(
    const Vec512<int16_t> a, const Vec512<int16_t> b) {
  return Vec512<int16_t>{_mm512_unpacklo_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> InterleaveLo(
    const Vec512<int32_t> a, const Vec512<int32_t> b) {
  return Vec512<int32_t>{_mm512_unpacklo_epi32(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> InterleaveLo(
    const Vec512<int64_t> a, const Vec512<int64_t> b) {
  return Vec512<int64_t>{_mm512_unpacklo_epi64(a.raw, b.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<float> InterleaveLo(const Vec512<float> a,
                                                      const Vec512<float> b) {
  return Vec512<float>{_mm512_unpacklo_ps(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> InterleaveLo(const Vec512<double> a,
                                                       const Vec512<double> b) {
  return Vec512<double>{_mm512_unpacklo_pd(a.raw, b.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<uint8_t> InterleaveHi(
    const Vec512<uint8_t> a, const Vec512<uint8_t> b) {
  return Vec512<uint8_t>{_mm512_unpackhi_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> InterleaveHi(
    const Vec512<uint16_t> a, const Vec512<uint16_t> b) {
  return Vec512<uint16_t>{_mm512_unpackhi_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> InterleaveHi(
    const Vec512<uint32_t> a, const Vec512<uint32_t> b) {
  return Vec512<uint32_t>{_mm512_unpackhi_epi32(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> InterleaveHi(
    const Vec512<uint64_t> a, const Vec512<uint64_t> b) {
  return Vec512<uint64_t>{_mm512_unpackhi_epi64(a.raw, b.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<int8_t> InterleaveHi(const Vec512<int8_t> a,
                                                       const Vec512<int8_t> b) {
  return Vec512<int8_t>{_mm512_unpackhi_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> InterleaveHi(
    const Vec512<int16_t> a, const Vec512<int16_t> b) {
  return Vec512<int16_t>{_mm512_unpackhi_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> InterleaveHi(
    const Vec512<int32_t> a, const Vec512<int32_t> b) {
  return Vec512<int32_t>{_mm512_unpackhi_epi32(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> InterleaveHi(
    const Vec512<int64_t> a, const Vec512<int64_t> b) {
  return Vec512<int64_t>{_mm512_unpackhi_epi64(a.raw, b.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<float> InterleaveHi(const Vec512<float> a,
                                                      const Vec512<float> b) {
  return Vec512<float>{_mm512_unpackhi_ps(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> InterleaveHi(const Vec512<double> a,
                                                       const Vec512<double> b) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> ZipLo(const Vec512<uint8_t> a,
                                                  const Vec512<uint8_t> b) {
  return Vec512<uint16_t>{_mm512_unpacklo_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> ZipLo(const Vec512<uint16_t> a,
                                                  const Vec512<uint16_t> b) {
  return Vec512<uint32_t>{_mm512_unpacklo_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> ZipLo(const Vec512<uint32_t> a,
                                                  const Vec512<uint32_t> b) {
  return Vec512<uint64_t>{_mm512_unpacklo_epi32(a.raw, b.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> ZipLo(const Vec512<int8_t> a,
                                                 const Vec512<int8_t> b) {
  return Vec512<int16_t>{_mm512_unpacklo_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> ZipLo(const Vec512<int16_t> a,
                                                 const Vec512<int16_t> b) {
  return Vec512<int32_t>{_mm512_unpacklo_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> ZipLo(const Vec512<int32_t> a,
                                                 const Vec512<int32_t> b) {
  return Vec512<int64_t>{_mm512_unpacklo_epi32(a.raw, b.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> ZipHi(const Vec512<uint8_t> a,
                                                  const Vec512<uint8_t> b) {
  return Vec512<uint16_t>{_mm512_unpackhi_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> ZipHi(const Vec512<uint16_t> a,
                                                  const Vec512<uint16_t> b) {
  return Vec512<uint32_t>{_mm512_unpackhi_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> ZipHi(const Vec512<uint32_t> a,
                                                  const Vec512<uint32_t> b) {
  return Vec512<uint64_t>{_mm512_unpackhi_epi32(a.raw, b.raw)};
}

HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> ZipHi(const Vec512<int8_t> a,
                                                 const Vec512<int8_t> b) {
  return Vec512<int16_t>{_mm512_unpackhi_epi8(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> ZipHi(const Vec512<int16_t> a,
                                                 const Vec512<int16_t> b) {
  return Vec512<int32_t>{_mm512_unpackhi_epi16(a.raw, b.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> ZipHi(const Vec512<int32_t> a,
                                                 const Vec512<int32_t> b) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ConcatLoLo(const Vec512<T> hi,
                                                const Vec512<T> lo) {
  return Vec512<T>{_mm512_shuffle_i32x4(lo.raw, hi.raw, _MM_PERM_BABA)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> ConcatLoLo(const Vec512<float> hi,
                                                    const Vec512<float> lo) {
  return Vec512<float>{_mm512_shuffle_f32x4(lo.raw, hi.raw, _MM_PERM_BABA)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> ConcatLoLo(const Vec512<double> hi,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ConcatHiHi(const Vec512<T> hi,
                                                const Vec512<T> lo) {
  return Vec512<T>{_mm512_shuffle_i32x4(lo.raw, hi.raw, _MM_PERM_DCDC)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> ConcatHiHi(const Vec512<float> hi,
                                                    const Vec512<float> lo) {
  return Vec512<float>{_mm512_shuffle_f32x4(lo.raw, hi.raw, _MM_PERM_DCDC)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> ConcatHiHi(const Vec512<double> hi,
                                                     const Vec512<double> lo) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ConcatLoHi(const Vec512<T> hi,
                                                const Vec512<T> lo) {
  return Vec512<T>{_mm512_shuffle_i32x4(lo.raw, hi.raw, 0x4E)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> ConcatLoHi(const Vec512<float> hi,
                                                    const Vec512<float> lo) {
  return Vec512<float>{_mm512_shuffle_f32x4(lo.raw, hi.raw, 0x4E)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> ConcatLoHi(const Vec512<double> hi,
                                                     const Vec512<double> lo) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> ConcatHiLo(const Vec512<T> hi,
                                                const Vec512<T> lo) {
...
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> ConcatHiLo(const Vec512<float> hi,
                                                    const Vec512<float> lo) {
  const __mmask16 mask = /*_cvtu32_mask16 */ (0x00FF);
  return Vec512<float>{_mm512_mask_blend_ps(mask, hi.raw, lo.raw)};
}
template <>
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> ConcatHiLo(const Vec512<double> hi,
                                                     const Vec512<double> lo) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> OddEven(const Vec512<T> a,
                                             const Vec512<T> b) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> TableLookupBytes(const Vec512<T> bytes,
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<double> ConvertTo(Full512<double> /* tag */,
                                                    Vec256<float> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint16_t> ConvertTo(
    Full512<uint16_t> /* tag */, Vec256<uint8_t> v) {
  return Vec512<uint16_t>{_mm512_cvtepu8_epi16(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> ConvertTo(
    Full512<uint32_t> /* tag */, Vec128<uint8_t> v) {
  return Vec512<uint32_t>{_mm512_cvtepu8_epi32(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int16_t> ConvertTo(Full512<int16_t> /* tag */,
                                                     Vec256<uint8_t> v) {
  return Vec512<int16_t>{_mm512_cvtepu8_epi16(v.raw)};
}
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> ConvertTo(Full512<int32_t> /* tag */,
                                                     Vec128<uint8_t> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> ConvertTo(
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint32_t> U32FromU8(const Vec512<uint8_t> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<int64_t> ConvertTo(Full512<int64_t> /* tag */,
                                                     Vec256<int32_t> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec256<uint16_t> ConvertTo(
...
HWY_ATTR_AVX512 HWY_INLINE Vec128<uint8_t, 16> ConvertTo(
...
HWY_ATTR_AVX512 HWY_INLINE Vec256<int16_t> ConvertTo(Full256<int16_t> /* tag */,
                                                     const Vec512<int32_t> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec128<int8_t, 16> ConvertTo(
...
HWY_ATTR_AVX512 HWY_INLINE Vec256<uint8_t> ConvertTo(Full256<uint8_t> /* tag */,
...
HWY_ATTR_AVX512 HWY_INLINE Vec256<int8_t> ConvertTo(Full256<int8_t> /* tag */,
                                                    const Vec512<int16_t> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec128<uint8_t, 16> U8FromU32(
    const Vec512<uint32_t> v) {
  const Full512<uint32_t> d32;
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<float> ConvertTo(Full512<float> /* tag */,
                                                   const Vec512<int32_t> v) {
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<int32_t> NearestInt(const Vec512<float> v) {
...
// For Clang and GCC, KORTEST wasn't added until recently.
    ...
    (HWY_COMPILER_GCC == 0 && HWY_COMPILER_CLANG == 0)
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllFalseImpl(SizeTag<1> /*tag*/,
                                             const Mask512<T> v) {
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllFalseImpl(SizeTag<2> /*tag*/,
                                             const Mask512<T> v) {
#if HWY_COMPILER_HAS_KORTEST
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllFalseImpl(SizeTag<4> /*tag*/,
                                             const Mask512<T> v) {
#if HWY_COMPILER_HAS_KORTEST
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllFalseImpl(SizeTag<8> /*tag*/,
                                             const Mask512<T> v) {
#if HWY_COMPILER_HAS_KORTEST
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllFalse(const Mask512<T> v) {
  return AllFalseImpl(SizeTag<sizeof(T)>(), v);
}

template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllTrueImpl(SizeTag<1> /*tag*/,
                                            const Mask512<T> v) {
#if HWY_COMPILER_HAS_KORTEST
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllTrueImpl(SizeTag<2> /*tag*/,
                                            const Mask512<T> v) {
#if HWY_COMPILER_HAS_KORTEST
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllTrueImpl(SizeTag<4> /*tag*/,
                                            const Mask512<T> v) {
#if HWY_COMPILER_HAS_KORTEST
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllTrueImpl(SizeTag<8> /*tag*/,
                                            const Mask512<T> v) {
#if HWY_COMPILER_HAS_KORTEST
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE bool AllTrue(const Mask512<T> v) {
  return AllTrueImpl(SizeTag<sizeof(T)>(), v);
}
...
HWY_ATTR_AVX512 HWY_INLINE Vec512<uint64_t> SumsOfU8x8(
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> horz_sum_impl(SizeTag<4> /* tag */,
...
template <typename T>
HWY_ATTR_AVX512 HWY_INLINE Vec512<T> horz_sum_impl(SizeTag<8> /* tag */,
                                                   const Vec512<T> v10) {
